...
<footer className="w-full text-emerald-500">

  <div className="pt-16 pb-12 text-sm border-t border-[#f7b55f4c] bg-[#ffeed94c] ">
    <div className="container px-6 mx-auto">
      <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
        <nav className="col-span-2 md:col-span-4 lg:col-span-3" aria-labelledby="footer-product-light">
          <h3 className="mb-6 text-base font-medium text-emerald-700" id="footer-product-light">Product</h3>
          <ul>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Features </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Customers </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Why us? </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Pricing </button>
            </li>
          </ul>
        </nav>
        <nav className="col-span-2 md:col-span-4 lg:col-span-3" aria-labelledby="footer-docs-light">
          <h3 className="mb-6 text-base font-medium text-emerald-700" id="footer-docs-light">Docs & help</h3>
          <ul>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Documentation</button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Training </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> System status </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> FAQ's </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Help Center </button>
            </li>
          </ul>
        </nav>
        <nav className="col-span-2 md:col-span-4 lg:col-span-3" aria-labelledby="footer-about-light">
          <h3 className="mb-6 text-base font-medium text-emerald-700" id="footer-about-light">About us</h3>
          <ul>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> About us </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Careers </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Leadership </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Blog</button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Events </button>
            </li>
          </ul>
        </nav>
        <nav className="col-span-2 md:col-span-4 lg:col-span-3" aria-labelledby="footer-get-in-touch-light">
          <h3 className="mb-6 text-base font-medium text-emerald-700" id="footer-get-in-touch-light">Get in touch</h3>
          <ul>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Contact </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Support </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Partners </button>
            </li>
            <li className="mb-2 leading-6">
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700"> Join research </button>
            </li>
          </ul>
        </nav>
      </div>
  ...
  <div className="py-4 text-sm border-t border-[#f7b55f4c] bg-[#f5d09f4c] ">
    <div className="container px-6 mx-auto">
      <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
        <div className="col-span-2 md:col-span-4 lg:col-span-6">Copyright 2024 Bookshelf</div>
        <nav aria-labelledby="footer-social-links-light" className="col-span-2 text-right md:col-span-4 lg:col-span-6">
          ...
          <ul className="flex items-center justify-end gap-4">
            <li>
              <button onClick={handleClick} className="transition-colors duration-300 hover:text-emerald-600 focus:text-emerald-700">
